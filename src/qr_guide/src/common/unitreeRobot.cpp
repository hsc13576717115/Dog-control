...
Go1Robot::Go1Robot(){
    _Legs[0] = new Go1Leg(0, Vec3( 0.1325,  -0.0565, 0));
    _Legs[1] = new Go1Leg(1, Vec3( 0.1325,   0.0565, 0));
    _Legs[2] = new Go1Leg(2, Vec3( -0.1325, -0.0565, 0));
    _Legs[3] = new Go1Leg(3, Vec3( -0.1325,  0.0565, 0));

    _feetPosNormalStand <<  0.2625,  0.2625, -0.2625, -0.2625,
                           -0.1555,  0.1555, -0.1555,  0.1555,
                           -0.3350, -0.3350, -0.3350, -0.3350;
